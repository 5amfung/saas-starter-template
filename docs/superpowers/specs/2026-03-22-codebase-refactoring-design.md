...
| File                                                                                             | Change                                                                                                                                                                                                                                                                                                                       |
| ------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `auth.server.ts`                                                                                 | Extract `buildSubscriptionLogPayload(subscription)` helper returning common fields; each handler adds event-specific fields (`cancellationDetails`, etc.). Remove all `await Promise.resolve()` and `return Promise.resolve()` no-ops (8 occurrences across subscription hooks, organization hooks, and `onCustomerCreate`). |
